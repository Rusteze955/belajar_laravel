                ...
                <form id="transactionForm">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input name="phone" type="number" id="customerPhone" class="form-control">
                        </div>
                        <div class="form-group">
                            <label for="" class="form-label">Alamat *</label>
                            <input name="address" class="form-control" id="customerAddress" cols="30" rows="10"></input>
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="number" name="qty[]" id="serviceWeight" step="any" min="0.1">
                        </div>
                        <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="notes" rows="3" id="notes" placeholder="Catatan khusus untuk pesanan..."></textarea>
                    </div>
